...
public class ESFInit implements ClientModInitializer {
    @Override
    public void onInitializeClient() { ESF.init(); }
//#elseif FORGE
...
//$$
//$$ @net.minecraftforge.fml.common.Mod("entity_sound_features")
...
//$$                 System.out.println("[Entity Sound Features]: Mod config broken, download latest forge version");
//$$             }
//$$
...
//$$                );
//$$            } catch (NoClassDefFoundError e) {
//$$                System.out.println("[Entity Sound Features]: Mod config broken, download latest neoforge version");
//$$            }
//$$            ESF.init();
//$$        }
//$$    }
